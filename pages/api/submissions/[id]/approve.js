...
// This API endpoint will approve a submission by its ID
export default function handler(req, res) {
    ...
    // Try to update the submission's status to "approved"
    const updated = updateSubmission(id, { status: 'approved' });
